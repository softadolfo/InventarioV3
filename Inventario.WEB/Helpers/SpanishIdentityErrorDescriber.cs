...
namespace Inventario.WEB.Helpers
{
    public class SpanishIdentityErrorDescriber : IdentityErrorDescriber
    {
        ...
        {
            return new IdentityError
            { Code = nameof(InvalidEmail), Description = $"El correo electrónico '{email}' es incorrecto." };
        }
        ...
        public override IdentityError DuplicateEmail(string email)
        {
            return new IdentityError
            {
                ...
                Description =
                    $"El correo electrónico '{email}' ya se encuentra registrado. Puede recuperar su contraseña para ingresar nuevamente al sistema."
            };
        }
